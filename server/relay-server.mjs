...
function sanitizeGesture(data) {
  ...
  return {
    ...
    metrics: {
      ...
      palmZ: clamp(metrics.palmZ, -1, 1),
      roll: clamp(metrics.roll, -1, 1),
      yaw: clamp(metrics.yaw, -1, 1),
      pitch: clamp(metrics.pitch, -1, 1),
      spread: clamp(metrics.spread),
      velocityX: clamp(metrics.velocityX, -1, 1),
      velocityY: clamp(metrics.velocityY, -1, 1),
      velocityZ: clamp(metrics.velocityZ, -1, 1),
      grab: clamp(metrics.grab),
      anchorX: clamp(metrics.anchorX, -1, 1),
      anchorY: clamp(metrics.anchorY, -1, 1),
